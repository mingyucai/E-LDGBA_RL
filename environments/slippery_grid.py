    ...
    def __init__(
        ...
        if self.layout is None:
            ...
            if self.layout == 'layout_1':  # assets/layout1.png
                self.labels = np.zeros([10, 10])
                #self.labels[25:35, 5:15] = self.assignment['unsafe']
                self.labels[2:4, 6:8] = self.assignment['unsafe']
                self.labels[5:6, 4:5] = self.assignment['goal_1']
                self.labels[8:10, 0:2] = self.assignment['goal_2']
